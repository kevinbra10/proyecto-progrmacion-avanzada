...
<body class="bg-slate-900 font-sans p-4 min-h-screen flex items-center justify-center">
    ...
    <div class="container mx-auto max-w-4xl grid grid-cols-1 md:grid-cols-2 gap-8 bg-white p-8 rounded-xl shadow-2xl">
        ...
        <div class="border-b md:border-b-0 md:border-r border-gray-200 pb-6 md:pb-0 md:pr-8">
            <div class="mb-6">
                <h2 class="text-xl font-bold text-gray-800 uppercase tracking-tight">Iniciar Sesión</h2>
        ...
        <div>
            <div class="mb-6">
                ...
                <p class="text-xs text-gray-500 mt-1">Regístrate ingresando tu carrera y tu semestre actual</p>
            </div>
            ...
            <form action="{{ route('login.procesar') }}" method="POST" class="space-y-4">
                ...
                <div>
                    ...
                    <select name="carrera" class="w-full p-3 border border-gray-300 rounded-lg text-sm bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500" required>
                        ...
                        <option value="Ciencias de la Comunicación Social">Ciencias de la Comunicación Social</option>
                    </select>
                </div>

                <div>
                    <label class="block text-xs font-bold text-gray-700 uppercase mb-1">Semestre</label>
                    <select name="semestre" class="w-full p-3 border border-gray-300 rounded-lg text-sm bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500" required>
